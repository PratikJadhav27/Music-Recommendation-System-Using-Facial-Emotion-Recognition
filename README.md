...
- **Ensemble Mode**: Optionally average softmax outputs from the baseline (`fer_model.h5`) and class-balanced (`fer_balanced.h5`) CNNs for more robust predictions (toggle in the sidebar).
